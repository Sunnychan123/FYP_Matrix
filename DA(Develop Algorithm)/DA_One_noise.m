...
% Step5: Run LSNNM-SVT-FPC algorithm
for iter = 1:maxiter
...
xlabel('Iteration');
ylabel('RMSE');
title('RMSE versus Iteration');

disp(['LSNNM-SVT-FPC algorithm converged after ' num2str(iter) ' iterations']);
